...
if (!$loggedin) {
            ...
            <div class="track-table-container">
                <table class="track-table">
                    ...
                    <tbody>';
                        ...
                        $query1 = "SELECT track.*, genre.*, `admin`.* FROM track LEFT JOIN genre ON track.GenreID = genre.GenreID 
                        LEFT JOIN `admin` ON track.AdminID = `admin`.AdminID
                        WHERE track.AdminID != 0 ORDER BY track.AdminID";
                            ...
                            if ($res->num_rows > 0) {
                                while ($row = $res->fetch_assoc()) {
                                    echo '<tr>
                                        ...
                                        <td class="action">
                                            <button onclick="edit('.$row['TrackID'].')" id="track" class="btn-track-info"><i class="fas fa-pen"></i></button>
    ...
    echo '<!-- Pop up window to upload track -->
    <div class="addTrack" id="newTrack">
            <form id="trackForm" class="trackForm" action="Track-Upload-Admin.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="track-cont">
                    <div class="track-detail1">
                        <div class="image-upload-wrap">
                            ...
                            <img id="preview-image2" src="#" alt="Preview Track Image" style="display:none;">
                        </div>
                    </div>
                    ...
                    <div class="track-detail2">
                        ...
                        <p class="release-date">Release Date :<input type="date" class="newTrack-input" name="releasedate" required style="width: 60%; margin-left: 10px;"></p>
                        <br>
