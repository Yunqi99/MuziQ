...
if (!$loggedin) { // Check if the user is not logged in
    ...
    <div class="admin-cont">
        <div class="bar-row">
            <h1>LIST OF PLATFORM PLAYLISTS</h1>
            <div class="bar-cont">
        ...
        <div class="track-table-container">
            <table class="track-table">
                ...
                <tbody>';
                $query1 = "SELECT playlist.*, `admin`.*, COUNT(playlist_track.TrackID) AS track_count, genre.* FROM playlist
                LEFT JOIN playlist_track ON playlist.PlaylistID = playlist_track.PlaylistID
                LEFT JOIN `admin` ON playlist.AdminID = `admin`.AdminID
                LEFT JOIN genre ON playlist.GenreID = genre.GenreID
                WHERE playlist.AdminID != 0
    ...
    <div class="addPlaylist" id="newPlaylist">
        <form id="playlistForm" class="playlistForm" action="Playlist-Create-Admin.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="playlist-cont">
                <div class="playlist-detail1">
                    <div class="image-upload-wrap">
                        ...
                        <input class="file-upload-input"  name="fileToUpload" type="file" onchange="readURL(this);" accept="image/*" style="display: none;" />
                ...
                <div class="playlist-detail2">
                    ...
                    <p><textarea name="playlistdesc" class="descplaylist-input" rows="4" cols="50" maxlength="100" placeholder="Describe your playlist. Within 100 words." required></textarea></p>
                    <br>
                    <input type="submit" class="button-newPlaylist" name="createPlaylist" value="Create">
                </div>
            </div>
